...
var horiz = COLOR([0,0,0])(T([1])([2])(CUBOID([25,1,0.7])));
var vert = COLOR([0,0,0])(T([0])([(num*(dx+0.3))+2])(CUBOID([1,10,0.7])));
complesso1 = T([1])([6])(settlement(5));
complesso2 = T([0])([(num*(dx+0.3))+3])(complesso1);


complesso = T([0,1,2])([2,dimY/2,5])(S([0,1,2])([0.4,0.4,0.4])(STRUCT([complesso1,complesso2,horiz,vert])));
DRAW(complesso);